...
class ApplicantSubjectController extends Controller
{
    protected ApplicantSubjectServiceInterface $subjectService;

    public function __construct(ApplicantSubjectServiceInterface $subjectService)
    {
    ...
    {
        $result = $this->subjectService->listSubjects($request->query('search'));

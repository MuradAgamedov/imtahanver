            ...
            <td style="padding: 40px 30px; color: #1f2937;">
                ...
                <p style="font-size: 15px; line-height: 24px; color: #4b5563; margin-bottom: 24px;">
                    @if($type === 'email_change')
                        Hesabınızın email ünvanını dəyişdirmək üçün müraciət etdiniz. Yeni email ünvanınızı təsdiqləmək üçün aşağıdakı 6 rəqəmli OTP kodunu daxil edin:
                    @elseif($type === 'password_change')
                        Hesabınızın şifrəsini dəyişdirmək üçün müraciət etdiniz. Şifrənizi yeniləmək üçün aşağıdakı 6 rəqəmli OTP kodunu daxil edin:
                    @else
                        Hesab əməliyyatını tamamlamaq üçün aşağıdakı 6 rəqəmli OTP kodunu daxil edin:
                    @endif
                </p>
                ...
                <p style="font-size: 13px; line-height: 20px; color: #9ca3af; margin-bottom: 0;">
                    Qeyd: Bu kod 10 dəqiqə ərzində etibarlıdır. Əgər bu müraciəti siz etməmisinizsə, bu məktubu silə bilərsiniz.
                </p>
            </td>
        </tr>
        <!-- Footer -->
